...
DefaultAssay(seurat) <- "RNA" # This analysis requires the rna assay
...
anno <- read.csv("~/project/Liver_Cell_Atlas/Analysis_01/03_Hepatocyte_star/Hepatocyte_Star_Annotations.csv", row.names =1)
