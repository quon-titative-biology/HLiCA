# Liver Cell Atlas - Hepatocyte (Clean) - Chosen Parameters
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/03_Clean/"
...
sink_name <- "02_Hepatocyte_Clean_chosen_parameters_console" # console_output
...
opts$Hepatocyte_clean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Hepatocyte_clean_anno_dir,"/", "Hepatocyte_clean.rds"))
...
annotations <- list(Beta.Annotation.Lineage = c("0" = "Hepatocyte",
                                                "1" = "Hepatocyte",
                                                "2" = "Hepatocyte",
                                                "3" = "Hepatocyte",
                                                "4" = "Hepatocyte",
                                                ...
                                                "13" = "Hepatocyte",
                                                "14" = "Hepatocyte"),
                    Beta.Annotation.SubLineage = c("0" = "Portal",    
                                                   "1" = "Central",           
                                                   "2" = "Ribosomal+ / FTL+", 
                                                   "3" = "Mito+",         
                                                   "4" = "ORM2+ / APOE+",        
                                                   ...
                                                   "6" = "SERPINE1+",                
                                                   "7" = "Cycling",                     
                                                   "8" = "Potentially Technical",                
                                                   "9" = "Potentially Technical",     
                                                   "10" = "Potentially Technical",                      
                                                   "11" = "Potentially Technical",     
                                                   "12" = "Potentially Technical",               
                                                   "13" = "Potentially Technical",
                                                   "14" = "Potentially Technical"),
                    Potential.Doublets.2 = c("0" = "FALSE",
                                             "1" = "FALSE",
                                             "2" = "FALSE",
                                             "3" = "TRUE",
                                             "4" = "FALSE",
...
DimPlot(seu, group.by = "Beta.Annotation.SubLineage", raster = FALSE)
DimPlot(seu, group.by = "Potential.Doublets.2", raster = FALSE)

df <- seu@meta.data[,c("Beta.Annotation.Lineage","Beta.Annotation.SubLineage","Potential.Doublets","Potential.Doublets.2" )]
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/03_Clean/chosen_parameters/Hepatocytes_Clean_annotations.csv")



hepatocyte_df <- read.csv("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/02_PreClean_2/chosen_parameters/Hepatocyte_Intermediate_annotations.csv", row.names = 1)
hepatocyte_df[names(seu$Beta.Annotation.Lineage),"Beta.Annotation.Lineage"] <- as.character(seu$Beta.Annotation.Lineage)
hepatocyte_df$Beta.Annotation.SubLineage <- "TBC"
hepatocyte_df[names(seu$Beta.Annotation.SubLineage),"Beta.Annotation.SubLineage"] <- as.character(seu$Beta.Annotation.SubLineage)
hepatocyte_df$Potential.Doublets.2 <- "FALSE"
hepatocyte_df[names(seu$Potential.Doublets.2),"Potential.Doublets.2"] <- as.character(seu$Potential.Doublets.2)
...
DimPlot(test, group.by = "Beta.Annotation.SubLineage", raster = FALSE)
DimPlot(test, group.by = "Potential.Doublets.2", raster = FALSE)

write.csv(hepatocyte_df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/Hepatocyte_annotations.csv")
...
presentation_create(title = "Liver Cell Atlas - Hepatocyte (Clean) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/03_Clean/Hepatocyte_Clean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/03_Clean/chosen_parameters/Hepatocyte_clean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/03_Clean/chosen_parameters/",
                    final_cluster_param = c("Beta.Annotation.Lineage","Beta.Annotation.SubLineage","Potential.Doublets.2"),
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/03_Clean/Hepatocyte_Clean_Data_Presenation.html")




### Save Harmony Components
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/03_Clean/chosen_parameters/Hepatocyte_clean.rds")
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Hepatocyte_clean_anno_dir, "/harmony_backup/")
