# Liver Cell Atlas - Hepatocyte (Preclean) - Chosen Parameters
...
seu_anno <- read.csv(
  file = paste0("~/project/Liver_Cell_Atlas/Analysis_02/01_Alpha_Annotations.csv")) |> # Read in file with lineage annoations
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/01_PreClean/"
...
sink_name <- "01_Hepatocyte_PreClean_Chosen_Parameters_console" # console_output
...
opts$meta_to_plot <-  c("suspension_type", "Phase","assay","donor_age",
                        "tissue","donor_sex","donor_ethnicity","STUDY")
...
opts$discrete_col_pal <- c("#D26263", "#6399CA", "#FABD6A", "#CBB3D8", "#FD9D9C", "#CD8240", "#6D8938", "#A7A6A7", "#7CBEEB", "#A883FD", "#9ACB9A", "#EEE484", 
                           ...
                           "#00FFB2", "#FB00CB", "#890076", "#FB9CD4", "#BA001C", "#A500FA", "#A36375", "#FE0DFA", "#D39EF5", "#FE60BA", "#22817E", "#00AB2A",
                           "#0D3BB4" )
...
opts$Hepatocyte_unclean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Hepatocyte_unclean_anno_dir,"/", "Hepatocyte_unclean.rds"))
...
# Added Annotations to the object differently than the other lineages as most of the annotations are hepatocytes and will just correct the ones that are not.

seu$Beta.Annotation.Lineage <- "Hepatocyte"
seu$Beta.Annotation.Lineage[seu$seurat_clusters == "11"] <- "Lymphocyte"
seu$Beta.Annotation.Lineage[seu$seurat_clusters == "13"] <- "Endothelia"
seu$Beta.Annotation.Lineage[seu$seurat_clusters == "14"] <- "Myeloid Cell"
seu$Beta.Annotation.Lineage[seu$seurat_clusters == "19"] <- "Mesenchyme"
table(seu$Beta.Annotation.Lineage)



seu$Potential.Doublets <- "FALSE"
seu$Potential.Doublets[seu$seurat_clusters == "11"] <- "TRUE"
...
seu$Potential.Doublets[seu$seurat_clusters == "19"] <- "TRUE"
seu$Potential.Doublets[seu$seurat_clusters == "23"] <- "TRUE"
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/01_PreClean/chosen_parameters/Hepatocyte_unclean_annotations.csv")
...
presentation_create(title = "Liver Cell Atlas - Hepatocyte (Unclean) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/01_PreClean/Hepatocyte_PreClean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/01_PreClean/chosen_parameters/Hepatocyte_unclean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/01_PreClean/chosen_parameters/",
                    final_cluster_param = "Beta.Annotation.Lineage",
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/06_Hepatocyte/01_PreClean/Hepatocyte_Unclean_Data_Presenation.html")
...
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Hepatocyte_unclean_anno_dir, "/harmony_backup/")
