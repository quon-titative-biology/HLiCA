...
tmp <- seurat
tmp$seurat_clusters <- factor(seurat$seurat_clusters, levels = c(0,1,2,3,5,6,10,11,   8,    4,7,    13, 14,    9,     12))
...
plot <- DotPlot(tmp, features = unique(c(unlist(opts$modules_group$Hendo), "NRXN1","ERBB3","SOX10","S100B")), group.by = "seurat_clusters") + ggplot2::coord_flip(x=c(1,73), y=c(1,15),clip = "off") + 
  ...
  annotate("text",x=-5,y=4,label="Lymphocyte",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 9, yend = 9,pointing="side") +
  annotate("text",x=-4,y=9,label="Cycling",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 10, yend = 11,pointing="side") +
  annotate("text",x=-4,y=10.5,label="Hepatocytes",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 12, yend = 13,pointing="side") +
  annotate("text",x=-4,y=12.5,label="Myeloid Cell",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 14, yend = 14,pointing="side") +
  annotate("text",x=-4,y=14,label="Endothelia",angle = 45) +  
  geom_brace(xstart = -1, xend = -3, ystart = 15, yend = 15,pointing="side") +
  annotate("text",x=-4,y=15,label="Doublet",angle = 45) +
  ...
  annotate("text",x=40.5,y=-2.5,label="MPs",angle = 45) +
  ...
  annotate("text",x=49,y=-2.7,label="T Cells",angle = 45) +
  geom_brace(xstart = 53, xend = 54, ystart = -1, yend = -2) +
  annotate("text",x=53,y=-2.7,label="B Cells",angle = 45) +
  ...
  annotate("text",x=57,y=-2.8,label="Mast Cells",angle = 45) +
  ...
  annotate("text",x=61.5,y=-2.8,label="Erythrocytes",angle = 45) +
  geom_brace(xstart = 65, xend = 65, ystart = -1, yend = -2) +
  annotate("text",x=64,y=-2.8,label="Neutrophils",angle = 45) +
