# Liver Cell Atlas - Lymphocyte (Preclean) - Chosen Parameters
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/"
...
sink_name <- "01_Lymphocyte_PreClean_chosen_parameters_console" # console_output
...
seu$Potential.Doublets <- plyr::mapvalues(seu$seurat_clusters, from = levels(seu$seurat_clusters), annotations$Potential.Doublets)
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/chosen_parameters/Lymphocyte_unclean_annotations.csv")


# Save Data
# Save updated metadata
opts$Lymphocye_unclean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Lymphocye_unclean_anno_dir,"/", "Lymphocyte_unclean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Lymphocyte (Unclean) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/Lymphocyte_PreClean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/chosen_parameters/Lymphocyte_unclean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/chosen_parameters/",
                    final_cluster_param = "Beta.Annotation.Lineage",
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/Lymphocyte_Unclean_Data_Presenation.html")
...
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Lymphocye_unclean_anno_dir, "/harmony_backup/")
