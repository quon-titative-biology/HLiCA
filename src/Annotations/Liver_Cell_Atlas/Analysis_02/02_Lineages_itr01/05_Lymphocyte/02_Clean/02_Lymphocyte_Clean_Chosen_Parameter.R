# Liver Cell Atlas - Lymphocyte (Clean) - Chosen Parameter
...
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/chosen_parameters/Lymphocyte_unclean.rds") 
seu <- obj$seu
opts <- list()
...
##-----------------------------------------------------------------------
opts$lineage_anno <- "Lymphocyte" #subset lineage
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/02_Clean/"
...
sink_name <- "02_Lymphocyte_Clean_chosen_parameters_console" # console_output
...
annotations <- list(Beta.Annotation.Lineage = c("0" = "Lymphocyte",
                                                "1" = "Lymphocyte",
                                                "2" = "Lymphocyte",
                                                "3" = "Lymphocyte",
                                                "4" = "Lymphocyte",
                                                ...
                                                "12" = "Lymphocyte",
                                                "13" = "Lymphocyte"),
                    Beta.Annotation.SubLineage = c("0" = "CD8+ / Cytotoxic T Cell",    
                                                   "1" = "CD4+ / MAIT T Cell",           
                                                   "2" = "Liver Resident / Dim NK Cell", 
                                                   "3" = "cNK / Bright NK Cell",         
                                                   "4" = "CD4+  / Helper T Cell",        
                                                   "5" = "Plasma B Cell",                
                                                   "6" = "Naive B Cell",                
                                                   "7" = "Cycling",                     
                                                   "8" = "Poor Quality",                
                                                   "9" = "CD8+ / Cytotoxic T Cell",     
                                                   "10" = "Doublet",                      
                                                   "11" = "CD4+ / Regulatory T Cell",     
                                                   "12" = "Stressed Cells",               
                                                   "13" = "Poor Quality"),
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/02_Clean/chosen_parameters/Lymphocyte_Clean_annotations.csv")

lymphocyte_df <- read.csv("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/01_PreClean/chosen_parameters/Lymphocyte_unclean_annotations.csv", row.names = 1)
lymphocyte_df[names(seu$Beta.Annotation.Lineage),"Beta.Annotation.Lineage"] <- as.character(seu$Beta.Annotation.Lineage)
lymphocyte_df$Beta.Annotation.SubLineage <- "TBC"
lymphocyte_df[names(seu$Beta.Annotation.SubLineage),"Beta.Annotation.SubLineage"] <- as.character(seu$Beta.Annotation.SubLineage)
lymphocyte_df$Potential.Doublets.2 <- "FALSE"
lymphocyte_df[names(seu$Potential.Doublets.2),"Potential.Doublets.2"] <- as.character(seu$Potential.Doublets.2)
...
test <- AddMetaData(test, lymphocyte_df)
...
write.csv(lymphocyte_df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/Lymphocyte_annotations.csv")

# Save Data
# Save updated metadata
opts$Lymphocyte_clean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Lymphocyte_clean_anno_dir,"/", "Lymphocyte_clean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Lymphocyte (Clean ish) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/02_Clean/Lymphocyte_Clean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/02_Clean/chosen_parameters/Lymphocyte_clean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/02_Clean/chosen_parameters/",
                    final_cluster_param = c("Beta.Annotation.Lineage","Beta.Annotation.SubLineage", "Potential.Doublets.2"),
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/02_Clean/Lymphocyte_Clean_Data_Presenation.html")



### Save Harmony Components
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/05_Lymphocyte/02_Clean/chosen_parameters/Lymphocyte_clean.rds")
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Lymphocyte_clean_anno_dir, "/harmony_backup/")
