...
vector <- 1:1000 # for random number generation for the subchonkify function
...
tmp <- seurat
tmp$seurat_clusters <- factor(seurat$seurat_clusters, levels = c(0,1,2,3,4,5,8,9,10,11,13,16,18,19,   6,7,  15, 20,    14,17,   12,  21))
Idents(tmp) <- "Alpha.Annotations.tmp"

plot <- DotPlot(tmp, features = unique(unlist(opts$modules_group$Hendo)), group.by = "seurat_clusters") + ggplot2::coord_flip(x=c(1,69), y=c(1,22),clip = "off") + 
  ...
  geom_brace(xstart = -1, xend = -3, ystart = 1, yend = 14,pointing="side") +
  annotate("text",x=-4,y=7.5,label="Mesenchyme",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 15, yend = 16,pointing="side") +
  annotate("text",x=-4,y=15.5,label="Hepatocytes",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 17, yend = 18,pointing="side") +
  annotate("text",x=-4,y=17.5,label="Endothelia",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 19, yend = 20,pointing="side") +
  annotate("text",x=-4,y=19.5,label="Erythrocyte",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 21, yend = 21,pointing="side") +
  annotate("text",x=-4,y=21,label="Myeloid Cell",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 22, yend = 22,pointing="side") +
  annotate("text",x=-4,y=22,label="Cholangiocyte",angle = 45) +

  geom_brace(xstart = 1, xend = 7, ystart = -1.7, yend = -3.5) +
  annotate("text",x=3,y=-4.5,label="Hepatocytes",angle = 45) +
  geom_brace(xstart = 8, xend = 14, ystart = -1.7, yend = -3.5) +
  annotate("text",x=10.5,y=-4.5,label="Cholangiocytes",angle = 45) +
  geom_brace(xstart = 15, xend = 22, ystart = -1.7, yend = -3.5) +
  annotate("text",x=17.5,y=-4.5,label="Endothelia",angle = 45) +
  geom_brace(xstart = 23, xend = 31, ystart = -1.7, yend = -3.5) +
  annotate("text",x=26,y=-4.5,label="Mesenchyme",angle = 45) +
  geom_brace(xstart = 32, xend = 33, ystart = -1.7, yend = -3.5) +
  annotate("text",x=31.5,y=-4.5,label="Mesothelia",angle = 45) +
  geom_brace(xstart = 34, xend = 37, ystart = -1.7, yend = -3.5) +
  annotate("text",x=34.5,y=-4.5,label="Leucocytes",angle = 45) +
  geom_brace(xstart = 38, xend = 43, ystart = -1.7, yend = -3.5) +
  annotate("text",x=40.5,y=-4,label="MPs",angle = 45) +
  geom_brace(xstart = 44, xend = 46, ystart = -1.7, yend = -3.5) +
  annotate("text",x=44,y=-4.5,label="Lymphocytes",angle = 45) +
  geom_brace(xstart = 47, xend = 52, ystart = -1.7, yend = -3.5) +
  annotate("text",x=49,y=-4.2,label="T Cells",angle = 45) +
  geom_brace(xstart = 53, xend = 54, ystart = -1.7, yend = -3.5) +
  annotate("text",x=53,y=-4.2,label="B Cells",angle = 45) +
  geom_brace(xstart = 55, xend = 56, ystart = -1.7, yend = -3.5) +
  annotate("text",x=55.5,y=-4,label="ILCs",angle = 45) +
  geom_brace(xstart = 57, xend = 58, ystart = -1.7, yend = -3.5) +
  annotate("text",x=57,y=-4.3,label="Mast Cells",angle = 45) +
  geom_brace(xstart = 59, xend = 60, ystart = -1.7, yend = -3.5) +
  annotate("text",x=59.5,y=-4,label="PDCs",angle = 45) +
  geom_brace(xstart = 61, xend = 64, ystart = -1.7, yend = -3.5) +
  annotate("text",x=61.5,y=-4.5,label="Erythrocytes",angle = 45) +
  geom_brace(xstart = 65, xend = 65, ystart = -1.7, yend = -3.5) +
  annotate("text",x=64,y=-4.5,label="Neutrophils",angle = 45) +
  geom_brace(xstart = 66, xend = 69, ystart = -1.7, yend = -3.5) +
  annotate("text",x=67,y=-4.5,label="Cycling",angle = 45) +
