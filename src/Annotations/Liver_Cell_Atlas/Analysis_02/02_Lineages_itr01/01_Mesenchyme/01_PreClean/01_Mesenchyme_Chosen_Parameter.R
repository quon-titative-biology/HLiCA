...
path <- "project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/01_Mesenchyme/01_PreClean/"
...
sink_name <- "01_Mesenchyme_Chosen_Parameters_console" # console_output
...
opts$res <- seq(from = 0.4, to = 0.4, by = 0.1)
...
DimPlot(seu, group.by = "Potential.Doublets")

df <- seu@meta.data[,c("Beta.Annotation.Lineage","Potential.Doublets")]
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/01_Mesenchyme/01_PreClean/chosen_parameters/Mesenchyme_unclean_annotations.csv")

# Save Data
# Save updated metadata
opts$Mesenchyme_unclean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Mesenchyme_unclean_anno_dir,"/", "Mesenchyme_unclean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Mesenchyme (Unclean) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/01_Mesenchyme/01_PreClean/Mesenchyme_Unclean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/01_Mesenchyme/01_PreClean/chosen_parameters/Mesenchyme_unclean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/01_Mesenchyme/01_PreClean/chosen_parameters/",
                    final_cluster_param = c("Beta.Annotation.Lineage", "Potential.Doublets"),
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/01_Mesenchyme/01_PreClean/Mesenchyme_Unclean_Data_Presenation.html")
...
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Mesenchyme_unclean_anno_dir, "/harmony_backup/")
