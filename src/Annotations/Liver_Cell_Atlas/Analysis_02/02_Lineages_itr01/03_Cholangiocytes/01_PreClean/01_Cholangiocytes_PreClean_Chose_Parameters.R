# Liver Cell Atlas - Cholangiocytes (Preclean) - Chosen Parameters
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/03_Cholangiocytes/01_PreClean/"
...
sink_name <- "01_Cholangiocytes_PreClean_chosen_parameters_console" # console_output
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/03_Cholangiocytes/01_PreClean/chosen_parameters/Cholangiocyte_unclean_annotations.csv")



# Save Data
# Save updated metadata
opts$Cholangiocyte_unclean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Cholangiocyte_unclean_anno_dir,"/", "Cholangiocyte_unclean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Cholangiocyte (Unclean) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/03_Cholangiocytes/01_PreClean/Cholangiocyte_PreClean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/03_Cholangiocytes/01_PreClean/chosen_parameters/Cholangiocyte_unclean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/03_Cholangiocytes/01_PreClean/chosen_parameters/",
                    final_cluster_param = "Beta.Annotation.Lineage",
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/03_Cholangiocytes/01_PreClean/Cholangiocyte_Unclean_Data_Presenation.html")
...
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Cholangiocyte_unclean_anno_dir, "/harmony_backup/")
