# Liver Cell Atlas - Myeloid Cell (Preclean) - Parameter Testing
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/"
...
sink_name <- "01_Myeloid_Cell_PreClean_Chosen_Parameters_console" # console_output
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/chosen_parameters/Myeloid_Cell_unclean_annotations.csv")



# Save Data
# Save updated metadata
opts$Myeloid_cells_unclean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Myeloid_cells_unclean_anno_dir,"/", "Myeloid_Cells_unclean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Myeloid Cell (Unclean) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/Myeloid_Cells_PreClean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/chosen_parameters/Myeloid_Cells_unclean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/chosen_parameters/",
                    final_cluster_param = "Beta.Annotation.Lineage",
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/Myeloid_Cell_Unclean_Data_Presenation.html")
...
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Myeloid_cells_unclean_anno_dir, "/harmony_backup/")
