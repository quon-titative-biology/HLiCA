# Liver Cell Atlas - Myeloid Cell (Clean) - Chosen Parameters
...
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/chosen_parameters/Myeloid_Cells_unclean.rds") 
seu <- obj$seu
opts <- list()
...
##-----------------------------------------------------------------------
opts$lineage_anno <- "Myeloid Cell" #subset lineage
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/02_Clean/"
...
sink_name <- "02_Myeloid_Cell_Clean_Chosen_parameter_console" # console_output
...
annotations <- list(Beta.Annotation.Lineage = c("0" = "Myeloid Cell",
                                                "1" = "Myeloid Cell",
                                                "2" = "Myeloid Cell",
                                                "3" = "Myeloid Cell",
                                                "4" = "Myeloid Cell",
                                                ...
                                                "11" = "Lymphocyte",
                                                "12" = "Myeloid Cell"),
                    Beta.Annotation.SubLineage = c("0" = "Classical Monocytes",
                                                   "1" = "Kupffer Cells",
                                                   "2" = "Kupffer Cells",
                                                   "3" = "Type 2 cDCs",
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/02_Clean/chosen_parameters/Myeloid_Cell_Clean_annotations.csv")

myeloid_cell_df <- read.csv("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/01_PreClean/chosen_parameters/Myeloid_Cell_unclean_annotations.csv", row.names = 1)
myeloid_cell_df[names(seu$Beta.Annotation.Lineage),"Beta.Annotation.Lineage"] <- as.character(seu$Beta.Annotation.Lineage)
myeloid_cell_df$Beta.Annotation.SubLineage <- "TBC"
myeloid_cell_df[names(seu$Beta.Annotation.SubLineage),"Beta.Annotation.SubLineage"] <- as.character(seu$Beta.Annotation.SubLineage)
myeloid_cell_df$Potential.Doublets.2 <- "FALSE"
myeloid_cell_df[names(seu$Potential.Doublets.2),"Potential.Doublets.2"] <- as.character(seu$Potential.Doublets.2)
...
test <- AddMetaData(test, myeloid_cell_df)
...
write.csv(myeloid_cell_df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/Myeloid_Cell_annotations.csv")

# Save Data
# Save updated metadata
opts$Myeloid_Cell_clean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Myeloid_Cell_clean_anno_dir,"/", "Myeloid_Cell_clean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Myeloid Cell (Clean ish) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/02_Clean/Myeloid_Cell_Clean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/02_Clean/chosen_parameters/Myeloid_Cell_clean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/02_Clean/chosen_parameters/",
                    final_cluster_param = c("Beta.Annotation.Lineage","Beta.Annotation.SubLineage", "Potential.Doublets.2"),
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/02_Clean/Myeloid_Cell_Clean_Data_Presenation.html")



### Save Harmony Components
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/04_Myeloid_Cell/02_Clean/chosen_parameters/Myeloid_Cell_clean.rds")
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Myeloid_Cell_clean_anno_dir, "/harmony_backup/")
