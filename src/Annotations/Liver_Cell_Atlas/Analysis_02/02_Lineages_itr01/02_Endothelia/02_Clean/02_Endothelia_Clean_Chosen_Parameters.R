# Liver Cell Atlas - Endothelia (Clean) - Chosen Parameters
...
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/chosen_parameters/Endothelia_unclean.rds") # Read in objects from QC
seu <- obj$seu
opts <- list()
...
##-----------------------------------------------------------------------
opts$lineage_anno <- "Endothelia" #subset lineage
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/02_Clean/"
...
sink_name <- "02_Endothelia_Clean_chosen_parameters_console" # console_output
...
annotations <- list(Beta.Annotation.Lineage = c("0" = "Endothelia",
                                                "1" = "Endothelia",
                                                "2" = "Endothelia",
                                                "3" = "Endothelia",
                                                "4" = "Endothelia",
                                                ...
                                                "6" = "Endothelia",
                                                "7" = "Endothelia"),
                    Beta.Annotation.SubLineage = c("0" = "LSEC",
                                                   "1" = "Hepatic Artery",
                                                   "2" = "LSEC",
                                                   "3" = "Portal Vein",
                                                   "4" = "Central Vein",
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/02_Clean/chosen_parameters/Endothelia_Clean_annotations.csv")

endothelia_df <- read.csv("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/chosen_parameters/Endothelia_unclean_annotations.csv", row.names = 1)
endothelia_df[names(seu$Beta.Annotation.Lineage),"Beta.Annotation.Lineage"] <- as.character(seu$Beta.Annotation.Lineage)
endothelia_df$Beta.Annotation.SubLineage <- "TBC"
endothelia_df[names(seu$Beta.Annotation.SubLineage),"Beta.Annotation.SubLineage"] <- as.character(seu$Beta.Annotation.SubLineage)
endothelia_df$Potential.Doublets.2 <- "FALSE"
endothelia_df[names(seu$Potential.Doublets.2),"Potential.Doublets.2"] <- as.character(seu$Potential.Doublets.2)
...
test <- AddMetaData(test, endothelia_df)
...
write.csv(endothelia_df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/Endothelia_annotations.csv")

# Save Data
# Save updated metadata
opts$Endothelia_clean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Endothelia_clean_anno_dir,"/", "Endothelia_clean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Endothelia (Clean ish) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/02_Clean/Endothelia_Clean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/02_Clean/chosen_parameters/Endothelia_clean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/02_Clean/chosen_parameters/",
                    final_cluster_param = c("Beta.Annotation.Lineage","Beta.Annotation.SubLineage", "Potential.Doublets.2"),
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/02_Clean/Endothelia_Clean_Data_Presenation.html")


### Save Harmony Components
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/02_Clean/chosen_parameters/Endothelia_clean.rds")
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Endothelia_clean_anno_dir, "/harmony_backup/")
