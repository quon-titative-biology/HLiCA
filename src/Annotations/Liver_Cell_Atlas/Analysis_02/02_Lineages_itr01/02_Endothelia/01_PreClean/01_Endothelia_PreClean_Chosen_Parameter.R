# Liver Cell Atlas - Endothelia (Preclean) - Parameter Testing
...
path <- "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/"
...
sink_name <- "01_Endothelia_PreClean_chosen_parameters_console" # console_output
...
write.csv(df, "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/chosen_parameters/Endothelia_unclean_annotations.csv")



# Save Data
# Save updated metadata
opts$Endothelia_unclean_anno_dir <- io$out_dir
saveRDS(object = list(seu = seu, opts = opts),
        file = paste0(opts$Endothelia_unclean_anno_dir,"/", "Endothelia_unclean.rds"))
...
presentation_create(title = "Liver Cell Atlas - Endothelia (Unclean) - Data Presentation", 
                    template = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/Endothelia_PreClean_template.Rmd", 
                    obj_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/chosen_parameters/Endothelia_unclean.rds", 
                    results_path = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/chosen_parameters/",
                    final_cluster_param = "Beta.Annotation.Lineage",
                    output_file = "~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/Endothelia_Unclean_Data_Presenation.html")


### Save Harmony Components
obj <- readRDS("~/project/Liver_Cell_Atlas/Analysis_02/02_Lineages_itr01/02_Endothelia/01_PreClean/chosen_parameters/Endothelia_unclean.rds")
seu <- obj$seu
opts <- obj$opts
path <- paste0(opts$Endothelia_unclean_anno_dir, "/harmony_backup/")
