...
tmp <- seurat
tmp$seurat_clusters <- factor(seurat$seurat_clusters, levels = c(0,1,2,3,4,6,7,8,11,12,14,16,18,   9,13,  5,  10,  15  , 17))
Idents(tmp) <- "Alpha.Annotations.tmp"

plot <- DotPlot(tmp, features = unique(unlist(opts$modules_group$Hendo)), group.by = "seurat_clusters") + ggplot2::coord_flip(x=c(1,69), y=c(1,19),clip = "off") + 
  ...
  annotate("text",x=-4,y=7,label="Endothelia",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 14, yend = 15,pointing="side") +
  annotate("text",x=-4,y=14.5,label="Myeloid Cell",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 16, yend = 16,pointing="side") +
  annotate("text",x=-4,y=16,label="Hepatocyte",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 17, yend = 17,pointing="side") +
  annotate("text",x=-4,y=17,label="Lymphocyte",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 18, yend = 18,pointing="side") +
  annotate("text",x=-4,y=18,label="Mesenchyme",angle = 45) +
  geom_brace(xstart = -1, xend = -3, ystart = 19, yend = 19,pointing="side") +
  annotate("text",x=-4,y=19,label="Erythrocyte",angle = 45) +
