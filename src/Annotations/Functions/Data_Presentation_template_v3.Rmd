...
seed <- 42 # Seed number for script
set.seed(seed) 
...
p <- feature_plot(seurat, features = c("nCount_RNA","nFeature_RNA", "percent.mt", "remain_counts_soupX","pct_contamin"), ncol = 2, raster = FALSE) 
p
```
...
dim_plot(seurat, group.by = params$final_cluster_param, label = T, col_pal = opts$discrete_col_pal, raster = FALSE)
```
