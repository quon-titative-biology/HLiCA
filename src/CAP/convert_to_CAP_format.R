...
path = "/share/quonlab/HLiCA/czi_liver_atlas/data/LiverNetworkData/alignment/ref_GRCh38p13_gencode_v42/share_2023_05_13/share_qc"
output_path = '/share/quonlab/HLiCA/czi_liver_atlas/data/LiverNetworkData/alignment/ref_GRCh38p13_gencode_v42/share_2023_05_13/share_qc/reformat'
for (study in dataset){
    ...
    for (sample in SAMPLE_ID){
        ...
        print('saving files...')
        dir.create(file.path(output_path, study), recursive=TRUE, showWarnings = FALSE)
